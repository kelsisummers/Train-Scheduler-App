...
database.ref().on('child_added', function(childSnapshot){
    ...
    '<div class="minutes-away col m1 ">' + minutesAway + '</div>' 
    + '<div class="col m3"><a class="update waves-effect waves-light btn">Update</a><a class="remove waves-effect waves-light btn">Remove</a></div></div>');
